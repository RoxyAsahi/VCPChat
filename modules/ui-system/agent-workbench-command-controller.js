function createWorkbenchCommandController(context) {
    const {
        store, requireApi, optionalApi, refreshStatus, selectedRuntime, selectedSessionId,
    ...
    return {
        ...
        workspaceSelectRoot: (payload) => requireApi('agentWorkspaceSelectRoot')(payload),
        ...
        workspaceSaveText: (payload) => requireApi('agentWorkspaceSaveText')(payload),
        workspaceWatch: (payload) => optionalApi('agentWorkspaceWatch')?.(payload) || null,
        workspaceUnwatch: (payload) => optionalApi('agentWorkspaceUnwatch')?.(payload) || null,
        workspaceSubscribeChanges: (listener) => optionalApi('onAgentWorkspaceChanged')?.(listener) || null,
        ...
        listSkills: (payload) => requireApi('agentRuntimeListSkills')(payload),
        readSkill: (payload) => requireApi('agentRuntimeReadSkill')(payload),
