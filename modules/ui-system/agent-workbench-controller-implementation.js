...
function createWorkbenchController(runtimeApi) {
    ...
    const {
        ...
        workspaceSelectRoot, workspaceListDirectory, workspaceReadPreview, workspaceSearchFiles,
        workspaceStatPath, workspaceSaveText, workspaceWatch, workspaceUnwatch, workspaceSubscribeChanges,
        workspacePerformPathAction, workspaceCancel,
        listAgentProfiles, listToolCatalog, listSkills, readSkill, getCachedModels, refreshModels, onModelsUpdated,
        saveAgentProfile, saveAgentAvatar,
