...
const IPC_CHANNELS = Object.freeze({
    ...
    LIST_SESSIONS: 'agent-runtime:list-sessions',
    GET_SESSION: 'agent-runtime:get-session',
    RENAME_SESSION: 'agent-runtime:rename-session',
    CLOSE_SESSION: 'agent-runtime:close-session',
    DELETE_SESSION: 'agent-runtime:delete-session',
    FORK_SESSION: 'agent-runtime:fork-session',
    GET_EVENTS: 'agent-runtime:get-events',
    GET_MESSAGES: 'agent-runtime:get-messages',
    GET_ARTIFACTS: 'agent-runtime:get-artifacts',
    GET_TOOL_CATALOG: 'agent-runtime:get-tool-catalog',
    REFRESH_TOOL_CATALOG: 'agent-runtime:refresh-tool-catalog',
    LIST_PATCH_PROPOSALS: 'agent-runtime:list-patch-proposals',
    GET_PATCH_PROPOSAL: 'agent-runtime:get-patch-proposal',
    REJECT_PATCH_PROPOSAL: 'agent-runtime:reject-patch-proposal',
