...
class SettingsValidator {
    static validate(settings, defaultSettings) {
        ...
        if (typeof validated.voiceInputShortcut !== 'string' || !validated.voiceInputShortcut.trim()) {
            ...
            const normalizedShortcut = validated.voiceInputShortcut.trim().toUpperCase();
            if (normalizedShortcut !== validated.voiceInputShortcut) hasIssues = true;
            validated.voiceInputShortcut = normalizedShortcut;
        }
