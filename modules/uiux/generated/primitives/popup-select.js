...
function ensureStyles() {
    ...
    style.textContent += '.vcp-harness-popup-select-viewport{overflow-x:hidden}.vcp-harness-popup-select-group+.vcp-harness-popup-select-group{margin-top:4px}.vcp-harness-popup-select-option-label{font-size:14px;line-height:20px;font-weight:500}.vcp-harness-popup-select-option-check{display:grid;place-items:center;flex:0 0 18px}.vcp-harness-popup-select-card[data-harness-equivalent="true"] .vcp-harness-popup-select-group-title{color:#81858c}.vcp-harness-popup-select-card[data-harness-equivalent="true"] .vcp-harness-popup-select-option{outline-offset:0}.vcp-harness-popup-select-action-row{position:relative;display:flex;align-items:center;width:100%}.vcp-harness-popup-select-action-row .vcp-harness-popup-select-option{padding-right:52px}.vcp-harness-popup-select-action-row .vcp-harness-popup-select-favorite{position:absolute;right:30px;top:50%;transform:translateY(-50%)}';
