...
2026-08-26 Field error fixture：VCP generated capture 新增真实 Field.error（`aria-invalid` + error node）fixture；Harness Field description/error 仍无独立生产 primitive 可直接捕获，继续保留为 reference 缺口，不伪造对照图。
