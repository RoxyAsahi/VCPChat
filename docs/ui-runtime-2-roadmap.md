...
completed_slice: semantic token projection + scope-owned SettingsUiService registry assembly + appearance/font/streaming/base-text/VCP connection projections, combo-control synchronization, legacy projection gating, and Electron evidence
