...
completed_slice: semantic token projection + scope-owned SettingsUiService registry assembly + appearance/font/streaming control projections, combo-control synchronization, and Electron evidence
