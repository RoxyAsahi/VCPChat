...
evidence: npm run check:uiux; npm run test:uiux; npm run test:electron-uiux-theme; node --test tests/state-authority.test.js tests/account-menu-controller.test.js tests/ui-manager-lifecycle.test.mjs
```
