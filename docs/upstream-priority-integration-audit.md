...
进行中：按拓扑顺序吸收 MobileSync/CDS 协议修复，当前已完成 `912d42cb` 至 `b4d7cd97`、`30c2f3fc`、`52df169a`、`006f2260`、`e1405a4c`、`8d7f8e7e` 的可验证子集，并以 `04a48377` 局部接入 `ba186996` 的配置摄取锁；`a8e13592` 已被当前源码等价覆盖，其余历史差异继续逐项审计。
