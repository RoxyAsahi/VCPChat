// This crate is a controlled Apache-2.0 import.  Keep upstream prose intact;
// newer Clippy versions flag an otherwise harmless list-continuation style in
// that prose when the workspace uses `-D warnings`.
