...
function createCatalog(ops) {
    return {
        ...
        agentRuntimeListSessions: query(() => ops.invoke('agent-runtime:list-sessions')),
        agentRuntimeGetSession: query((data) => ops.invoke('agent-runtime:get-session', data)),
        agentRuntimeRenameSession: query((data) => ops.invoke('agent-runtime:rename-session', data)),
        agentRuntimeCloseSession: query((data) => ops.invoke('agent-runtime:close-session', data)),
        agentRuntimeDeleteSession: query((data) => ops.invoke('agent-runtime:delete-session', data)),
        agentRuntimeForkSession: query((data) => ops.invoke('agent-runtime:fork-session', data)),
        agentRuntimeGetEvents: query((data) => ops.invoke('agent-runtime:get-events', data)),
        agentRuntimeGetMessages: query((data) => ops.invoke('agent-runtime:get-messages', data)),
        agentRuntimeGetArtifacts: query((data) => ops.invoke('agent-runtime:get-artifacts', data)),
        agentRuntimeGetToolCatalog: query((data) => ops.invoke('agent-runtime:get-tool-catalog', data)),
        agentRuntimeRefreshToolCatalog: query(() => ops.invoke('agent-runtime:refresh-tool-catalog')),
        agentRuntimeListPatchProposals: query((data) => ops.invoke('agent-runtime:list-patch-proposals', data)),
        agentRuntimeGetPatchProposal: query((data) => ops.invoke('agent-runtime:get-patch-proposal', data)),
        ...
        onAgentRuntimeEvent: subscription(ops.subscribe('agent-runtime:event', (_event, eventData) => eventData)),
...
const ALLOWED_KEYS = [
    ...
    "onVCPStreamChunk",
    "interruptVcpRequest",
    "agentRuntimeGetStatus",
    "agentRuntimeStart",
    "agentRuntimeStop",
    "agentRuntimeCreateSession",
    "agentRuntimeListSessions",
    "agentRuntimeGetSession",
    "agentRuntimeRenameSession",
    "agentRuntimeCloseSession",
    "agentRuntimeDeleteSession",
    "agentRuntimeForkSession",
    "agentRuntimeGetEvents",
    "agentRuntimeGetMessages",
    "agentRuntimeGetArtifacts",
    "agentRuntimeGetToolCatalog",
    "agentRuntimeRefreshToolCatalog",
    "agentRuntimeListPatchProposals",
    "agentRuntimeGetPatchProposal",
    "agentRuntimeRejectPatchProposal",
    "agentRuntimeCompactSession",
    "agentRuntimeStartTurn",
    "agentRuntimeSteerTurn",
    "agentRuntimeCancelTurn",
    "agentRuntimeRespondApproval",
