...
function createCatalog(ops) {
    return {
        ...
        agentRuntimeRenameTopic: query((data) => ops.invoke('agent-runtime:rename-topic', data)),
        agentRuntimeDeleteTopic: query((data) => ops.invoke('agent-runtime:delete-topic', data)),
        agentRuntimeListInteractionQueue: query(() => ops.invoke('agent-runtime:list-interaction-queue')),
        agentRuntimeReplaceInteractionQueue: query((data) => ops.invoke('agent-runtime:replace-interaction-queue', data)),
        agentRuntimeClearInteractionQueue: query(() => ops.invoke('agent-runtime:clear-interaction-queue')),
        agentRuntimeGetWorkbenchSettings: query(() => ops.invoke('agent-runtime:get-workbench-settings')),
        agentRuntimeUpdateWorkbenchSettings: query((data) => ops.invoke('agent-runtime:update-workbench-settings', data)),
        ...
        agentRuntimeFollowUpTurn: query((data) => ops.invoke('agent-runtime:follow-up-turn', data)),
...
const ALLOWED_KEYS = [
    ...
    "agentRuntimeListTopics",
    "agentRuntimeReadTopic",
    "agentRuntimeTakeoverTopic",
    "agentRuntimeRenameTopic",
    "agentRuntimeDeleteTopic",
    "agentRuntimeListInteractionQueue",
    "agentRuntimeReplaceInteractionQueue",
    "agentRuntimeClearInteractionQueue",
    "agentRuntimeGetWorkbenchSettings",
    "agentRuntimeUpdateWorkbenchSettings",
    "agentRuntimeStartTurn",
    "agentRuntimeSteerTurn",
    "agentRuntimeFollowUpTurn",
