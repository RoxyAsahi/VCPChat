...
function createCatalog(ops) {
    return {
        ...
        agentRuntimeListToolCatalog: query(() => ops.invoke('agent-runtime:list-tool-catalog')),
        agentRuntimeListSkills: query((data) => ops.invoke('agent-runtime:list-skills', data)),
        agentRuntimeReadSkill: query((data) => ops.invoke('agent-runtime:read-skill', data)),
        ...
        agentRuntimeApplyAgentProfile: query((data) => ops.invoke('agent-runtime:apply-agent-profile', data)),
        ...
        agentRuntimeEnsureSessionRuntime: query((data) => ops.invoke('agent-runtime:ensure-session-runtime', data)),
        agentRuntimeSetSessionPinned: query((data) => ops.invoke('agent-runtime:set-session-pinned', data)),
        agentRuntimeCompactSession: query((data) => ops.invoke('agent-runtime:compact-session', data)),
        agentRuntimeSearchTopics: query((data) => ops.invoke('agent-runtime:search-topics', data)),
        agentRuntimeSearchTopicMessages: query((data) => ops.invoke('agent-runtime:search-topic-messages', data)),
        agentRuntimeGetTopicIndexStatus: query(() => ops.invoke('agent-runtime:get-topic-index-status')),
        agentRuntimeRebuildTopicIndex: query(() => ops.invoke('agent-runtime:rebuild-topic-index')),
        agentRuntimeExportSession: query((data) => ops.invoke('agent-runtime:export-session', data)),
        agentRuntimeListRecoveryOperations: query(() => ops.invoke('agent-runtime:list-recovery-operations')),
        agentRuntimeListRecoveryCandidates: query(() => ops.invoke('agent-runtime:list-recovery-candidates')),
        agentRuntimeResolveRecoveryOperation: query((data) => ops.invoke('agent-runtime:resolve-recovery-operation', data)),
        ...
        agentRuntimeReadSessionDiagnostics: query((data) => ops.invoke('agent-runtime:read-session-diagnostics', data)),
        agentRuntimeUpdateSessionConfig: query((data) => ops.invoke('agent-runtime:update-session-config', data)),
        agentRuntimeReapplySessionConfig: query((data) => ops.invoke('agent-runtime:reapply-session-config', data)),
        ...
        agentRuntimeRespondInteraction: query((data) => ops.invoke('agent-runtime:respond-interaction', data)),
        ...
        agentSessionCreate: query((data) => ops.invoke('agent-session:create', data)),
        agentSessionList: query((data) => ops.invoke('agent-session:list', data)),
        agentSessionRead: query((data) => ops.invoke('agent-session:read', data)),
        agentSessionReadProjection: query((data) => ops.invoke('agent-session:read-projection', data)),
        agentSessionRename: query((data) => ops.invoke('agent-session:rename', data)),
        agentSessionArchive: query((data) => ops.invoke('agent-session:archive', data)),
        agentSessionRestore: query((data) => ops.invoke('agent-session:restore', data)),
        agentSessionDelete: query((data) => ops.invoke('agent-session:delete', data)),
        agentSessionFork: query((data) => ops.invoke('agent-session:fork', data)),
        agentWorkspaceSelectRoot: query((data) => ops.invoke('agent-workspace:select-root', data)),
        agentWorkspaceListDirectory: query((data) => ops.invoke('agent-workspace:list-directory', data)),
        agentWorkspaceReadPreview: query((data) => ops.invoke('agent-workspace:read-preview', data)),
        agentWorkspaceSearchFiles: query((data) => ops.invoke('agent-workspace:search-files', data)),
        agentWorkspaceStatPath: query((data) => ops.invoke('agent-workspace:stat-path', data)),
        agentWorkspaceSaveText: query((data) => ops.invoke('agent-workspace:save-text', data)),
        agentWorkspaceWatch: query((data) => ops.invoke('agent-workspace:watch', data)),
        agentWorkspaceUnwatch: query((data) => ops.invoke('agent-workspace:unwatch', data)),
        onAgentWorkspaceChanged: subscription(ops.subscribe('agent-workspace:changed', (_event, data) => data)),
        agentWorkspacePerformPathAction: query((data) => ops.invoke('agent-workspace:perform-path-action', data)),
        agentWorkspaceCancel: query((data) => ops.invoke('agent-workspace:cancel', data)),
...
const ALLOWED_KEYS = [
    ...
    "onVCPStreamChunk",
    "interruptVcpRequest",
    "agentRuntimeListAgentProfiles",
    "agentRuntimeListToolCatalog",
    "agentRuntimeListSkills",
    "agentRuntimeReadSkill",
    "agentRuntimeSaveAgentProfile",
    "agentRuntimeSaveAgentAvatar",
    "agentRuntimeApplyAgentProfile",
    "agentRuntimeGetStatus",
    "agentRuntimeStart",
    "agentRuntimeStop",
    "agentRuntimeEnsureSessionRuntime",
    "agentRuntimeSetSessionPinned",
    "agentRuntimeCompactSession",
    "agentRuntimeSearchTopics",
    "agentRuntimeSearchTopicMessages",
    "agentRuntimeGetTopicIndexStatus",
    "agentRuntimeRebuildTopicIndex",
    "agentRuntimeExportSession",
    "agentRuntimeListRecoveryOperations",
    "agentRuntimeListRecoveryCandidates",
    ...
    "agentSessionDelete",
    "agentSessionFork",
    "agentWorkspaceListDirectory",
    "agentWorkspaceReadPreview",
    "agentWorkspaceSearchFiles",
    "agentWorkspaceStatPath",
    "agentWorkspaceSaveText",
    "agentWorkspaceWatch",
    "agentWorkspaceUnwatch",
    "onAgentWorkspaceChanged",
    "agentWorkspacePerformPathAction",
    "agentWorkspaceCancel",
    "createAgentGroup",
    "getAgentGroups",
    "getAgentGroupConfig",
