...
function createCatalog(ops) {
    return {
        ...
        agentRuntimeCreateTopic: query((data) => ops.invoke('agent-runtime:create-topic', data)),
        ...
        agentRuntimeRestoreSession: query((data) => ops.invoke('agent-runtime:restore-session', data)),
        ...
        agentRuntimeReadProjection: query((data) => ops.invoke('agent-runtime:read-projection', data)),
        ...
        agentRuntimePermanentlyDeleteSession: query((data) => ops.invoke('agent-runtime:permanently-delete-session', data)),
...
const ALLOWED_KEYS = [
    ...
    "agentRuntimePermanentlyDeleteSession",
