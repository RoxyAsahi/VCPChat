...
const report = {
  ...
  pass: false,
  missingEvidence: ['VCP Candidate uses body portal while Harness source keeps the bubble in the anchor parent', 'normalized tooltip ROI pixel diff', 'VCP production consumer'],
};
