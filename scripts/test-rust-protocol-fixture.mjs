...
assert.equal(fixture.protocolRevision, '1.4');
...
assert.equal(ready.protocolRevision, '1.4');
...
for (const field of ['eventId', 'sequence', 'timestamp', 'runtime', 'sessionId', 'topicId', 'messageId']) assert.ok(event[field] !== undefined, `v1.4 event requires ${field}`);
console.log('Rust daemon v1.4 shared fixture contract passed.');
