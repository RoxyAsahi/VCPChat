...
assert.equal(fixture.protocolRevision, '1.2');
...
assert.equal(ready.protocolRevision, '1.2');
...
for (const field of ['eventId', 'sequence', 'timestamp', 'runtime', 'sessionId', 'topicId', 'messageId']) assert.ok(event[field] !== undefined, `v1.2 event requires ${field}`);
console.log('Rust daemon v1.2 shared fixture contract passed.');
