...
assert.match(bridge, /syncAdvancedSettingsVisibility\(form\)/, 'bridge must invoke the advanced section helper');
assert.match(bridge, /syncRustAssistantVisibility\(form\)/, 'bridge must invoke the Rust section helper');
