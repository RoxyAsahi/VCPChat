...
const invalidateGeneration = manager.lifecycle.invalidate.bind(manager.lifecycle);
manager.lifecycle.invalidate = (reason) => { order.push('generation'); invalidateGeneration(reason); };
