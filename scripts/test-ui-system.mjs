...
// This remains legacy bootstrap metadata only.  The main renderer has one
// canonical Settings presentation; it must never select a second Classic
// bridge/runtime or leave a form without its compatibility enhancement.
...
assert.equal(window.VCPUISettingsBridge.enhancedCount, 1);
await window.VCPUISettingsBridge.destroy();
