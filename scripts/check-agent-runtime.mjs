...
const requiredFiles = [
    ...
    'modules/ui-system/agent-workspace-view.js',
    'modules/ui-system/agent-workbench-header-view.js',
    'modules/ui-system/agent-workbench-account-view.js',
    'modules/ui-system/agent-activity-readonly-view.js',
