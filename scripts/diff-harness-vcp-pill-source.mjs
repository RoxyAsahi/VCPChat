...
const report = { generatedAt: new Date().toISOString(), comparison: 'same Chromium engine, real Harness Pill.tsx source fixture versus VCP Candidate fixture', semanticFixture: { pass: harness.semanticFixture === vcp.semanticFixture }, states, structuralPass: states.every(state => state.structuralPass), computedStylePass: states.every(state => state.computedStylePass), interaction, pass: false, missingEvidence: ['strict Pill ROI pixel diff', 'VCP production consumer'] };
