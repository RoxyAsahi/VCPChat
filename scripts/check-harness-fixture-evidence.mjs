...
const vcpBrowserSelectValid = vcpBrowserSelect?.source === 'VCP generated artifact Playwright fixture' && vcpBrowserSelect?.semanticFixture === 'agent-preset-selection/ready/Standard mode/open-selected-menu' && typeof vcpBrowserSelect.dom === 'string' && Array.isArray(vcpBrowserSelect.items) && vcpBrowserSelect.items.length === 4;
