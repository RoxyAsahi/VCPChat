...
const specs = [
  { name: 'agent-preset-seat', source: ['packages/client/ui-agent-preset/src/client/AgentPresetSeat.tsx', 'packages/client/ui-agent-preset/src/client/PresetMenu.tsx'], candidate: 'modules/uiux/primitives/agent-preset-seat.ts', provenanceGuard: 'scripts/check-harness-agent-preset-seat-source-provenance.mjs', boundary: 'VCP assistantAgent/chat switching chain is frozen', gaps: ['real Harness source browser capture', 'same-semantic DOM/ARIA and computed-style diff', 'same-semantic pixel diff'] },
  ...
  { name: 'disclosure-row', source: ['packages/client/ui-primitives/src/DisclosureRow.tsx'], candidate: 'modules/uiux/primitives/disclosure-row.ts', provenanceGuard: 'scripts/check-harness-disclosure-row-source-provenance.mjs', boundary: 'VCP chat/message consumer is frozen', gaps: ['same-semantic Harness/VCP pixel diff', 'VCP production consumer'] },
];
